    ...
    Filiere.find()
        .then(async response =>{
            ...
            if (response.length==0) {
                ...
                console.log(departs)
                req.session.user={user:req.session.user.user, annonces:req.session.user.annonces, departement:req.session.user.departement,  facultes:req.session.user.facultes, type:req.session.user.type, filiere:[],facs:facs,departs:departs};  
                res.render('filiere',req.session.user) 
            ...
            if (i==response.length) {
                ...
                req.session.user={user:req.session.user.user, annonces:req.session.user.annonces, departement:req.session.user.departement,  facultes:req.session.user.facultes, type:req.session.user.type, filiere :response,facs:facs,departs:departs};  
                res.render('filiere',req.session.user) 
            }
                });
